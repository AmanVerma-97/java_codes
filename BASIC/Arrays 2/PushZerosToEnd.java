...
//We're only handling the function here.


public class PushZerosToEnd {
    public static void pushZerosAtEnd(int[] arr) {
    	int total=0; //keeps track of total elements inserted in array.
        ...
        while(total<arr.length) //since we want initial and final number of total elements to be the same, we insert 0s till len-1.
        {
            arr[total]=0;
            total++;
        }
